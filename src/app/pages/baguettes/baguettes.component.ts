...
@Component({
  selector: 'app-baguettes',
  templateUrl: './baguettes.component.html',
  styleUrls: ['./baguettes.component.css']
})
export class BaguettesComponent implements OnInit {
  ...
  verticalBarFilters: FBFilter[] = [
    ...
    new CheckboxFilter('condition', 'Condition', this.conditions, 9),
    new CheckboxFilter('display-size', 'Display Size', this.displaySizes, 9),
    new CheckboxFilter('ram-size', 'RAM Size', this.ramSize, 9)
  ]
